...
// Let SD_FINISHED_RELEASECOMMAND stand in for SD_FINISHED_STEPPERRELEASE
  ...
  #endif
  #if !((HAS_MARLINUI_MENU || HAS_DWIN_E3V2 || HAS_DWIN_E3V3SE) && (ENCODER_5X_STEPS_PER_SEC || ENCODER_10X_STEPS_PER_SEC || ENCODER_100X_STEPS_PER_SEC))
...
#endif
#if ANY(EXTENSIBLE_UI, IS_NEWPANEL, EMERGENCY_PARSER, HAS_ADC_BUTTONS, HAS_DWIN_E3V2, HAS_DWIN_E3V3SE)
...
// Power-Loss Recovery
  ...
  #endif
  #if ANY(DWIN_CREALITY_LCD, DWIN_CREALITY_E3V3SE_LCD, DWIN_LCD_PROUI)
