 ...
 */
  ...
  #if HAS_SD_DETECT && NONE(HAS_GRAPHICAL_TFT, LCD_USE_DMA_FSMC, HAS_FSMC_GRAPHICAL_TFT, HAS_SPI_GRAPHICAL_TFT, IS_DWIN_MARLINUI, EXTENSIBLE_UI, HAS_DWIN_E3V2, HAS_DWIN_E3V3SE, HAS_U8GLIB_I2C_OLED)
...
#if HAS_TEMPERATURE && ANY(HAS_MARLINUI_MENU, HAS_DWIN_E3V2, HAS_DWIN_E3V3SE, HAS_DGUS_LCD_CLASSIC)
...
#if ANY(SCROLL_LONG_FILENAMES, HAS_DWIN_E3V2, HAS_DWIN_E3V3SE, TFT_COLOR_UI)
