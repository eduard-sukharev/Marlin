 ...
 */
  ...
  #if NONE(EXTENSIBLE_UI, HAS_MARLINUI_MENU, DWIN_CREALITY_LCD, DWIN_CREALITY_E3V3SE_LCD, DWIN_CREALITY_LCD_JYERSUI, DWIN_LCD_PROUI)
 ...
 */
  ...
  + COUNT_ENABLED(DWIN_CREALITY_LCD, DWIN_CREALITY_E3V3SE_LCD, DWIN_LCD_PROUI, DWIN_CREALITY_LCD_JYERSUI, DWIN_MARLINUI_PORTRAIT, DWIN_MARLINUI_LANDSCAPE, SOVOL_SV06_RTS) \
 ...
 */
  ...
  #if !HAS_MEDIA
    #error "DWIN_CREALITY_E3V3SE_LCD requires SDSUPPORT to be enabled."
  #elif ANY(PID_EDIT_MENU, PID_AUTOTUNE_MENU)
    #error "DWIN_CREALITY_E3V3SE_LCD does not support PID_EDIT_MENU or PID_AUTOTUNE_MENU."
  #elif ANY(MPC_EDIT_MENU, MPC_AUTOTUNE_MENU)
    #error "DWIN_CREALITY_E3V3SE_LCD does not support MPC_EDIT_MENU or MPC_AUTOTUNE_MENU."
  #elif ENABLED(LCD_BED_TRAMMING)
    #error "DWIN_CREALITY_E3V3SE_LCD does not support LCD_BED_TRAMMING."
  #elif ALL(LCD_BED_LEVELING, PROBE_MANUALLY)
    #error "DWIN_CREALITY_E3V3SE_LCD does not support LCD_BED_LEVELING with PROBE_MANUALLY."
  #endif
  ...
  #if !HAS_ENCODER_ACTION && NONE(HAS_DWIN_E3V2, HAS_DWIN_E3V3SE)
    ...
    #endif
  #elif !PIN_EXISTS(LCD_BACKLIGHT) && NONE(HAS_DWIN_E3V2, HAS_DWIN_E3V3SE)
    #error "LCD_BACKLIGHT_TIMEOUT_MINS requires LCD_BACKLIGHT_PIN, NEOPIXEL_BKGD_INDEX_FIRST, or an Ender-3 V2/V3 SE DWIN LCD."
  #endif
#elif HAS_DISPLAY_SLEEP
